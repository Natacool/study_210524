...
public class LoggingAspect {
    ...
    public Object mdcServiceController(@NotNull final ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            logAndControllerGetErrorMessage(queryMethod, args, ex, startTime);
            throw ex;
        }
    }
    ...
    private void logAndControllerGetErrorMessage(final String queryMethod, final Object[] args, final Exception ex, final long startTime) {
        long callTime = System.currentTimeMillis() - startTime;
    ...
    public Object mdcServiceService(@NotNull final ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            logAndServiceGetErrorMessage(queryMethod, args, ex, startTime);
            throw ex;
        }
    }
    ...
    private void logAndServiceGetErrorMessage(final String queryMethod, final Object[] args, final Exception ex, final long startTime) {
        long callTime = System.currentTimeMillis() - startTime;
        String errorMsg = String.format(
                "args=%s;",
                Arrays.toString(args)
