...
class UsersServiceTest {
    ...
    void insertUsersTest() {
        ...
        //UserDto actualUserDto = usersServiceTest.createUser(userDtoTestInput); //запуск реального метода
        UserDto actualUserDto = usersServiceTest.insertUser(userDtoTestInput); //запуск реального метода
    ...
    void deleteUsersByIdTest() {
        ...
        usersServiceTest.deleteUserById(testId); //запуск реального метода
    ...
    void deleteUsersByIdNotFoundTest() {
        ...
        assertThrows(NullPointerException.class, () -> usersServiceTest.deleteUserById(testId));
    }
