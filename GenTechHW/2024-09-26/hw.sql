...
SELECT employees.first_name, employees.last_name, regions.region_name
FROM employees
...
-- SELECT employees.first_name, employees.last_name, departments.department_id, employees.salary, departments.department_name
...
SELECT DISTINCT departments.department_name, locations.city
FROM departments
JOIN locations ON locations.location_id = departments.location_id
WHERE locations.city = "Seattle"
ORDER BY departments.department_name ASC LIMIT 3;
